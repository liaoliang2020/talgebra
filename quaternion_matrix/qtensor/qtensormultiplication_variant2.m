function qtensor_product = qtensormultiplication_variant2(qmatrix, qtensor, mod_k)
	...
	% the folowing line is revised to a different version. 
	% qtensor_product = qmatrix_multiplication(qmatrix, tensorfactorkflattening(qtensor, mod_k));
	qtensor_product = qmatrix_multiplication_transpose_version(qmatrix, tensorfactorkflattening(qtensor, mod_k));
