function  result = iffts(qarray, dumb_arg, mode, unit_quaternionic_square_roots)
	% this function generalizes the canonical MATLAB ifft function
	% which generalizes the canonica corresponding function
	...
	qmatrix = inv_quaternionic_fourier_matrix(size(qarray, mode), unit_quaternionic_square_roots);
